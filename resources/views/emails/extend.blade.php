...
<body
    ...
    <center>
        <table
            ...
            <tr>
                <td>
                    <h1 style="margin: 0;">Vaše rezervace byla prodloužena</h1>
                </td>
            </tr>
            <tr>
                <td>
                    <p>Dobrý den,<br>právě jsme prodloužili lhůtu na vrácení Vámi vypůjčené knihy
                        {{ $booking->book->title }} o jeden měsíc. Přejeme příjemné čtení a prosíme o včasné navrácení
                        knihy.</p>
                </td>
            </tr>
            <tr>
