        ...
        <form method="POST" action="/kniha/{{ $book->id }}" enctype="multipart/form-data"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="p-2 w-full border border-slate-200 rounded-lg" name="title"
                    ...
                    value="{{ old('title') == '' ? $book->title : old('title') }}" autocomplete="off">
                @error('title')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="p-2 w-full border border-slate-200 rounded-lg" name="subtitle"
                    ...
                    value="{{ old('subtitle') == '' ? $book->subtitle : old('subtitle') }}" autocomplete="off">
                @error('subtitle')
                    <p class="text-red-500 text-sm">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="description" class="p-2 w-full border border-slate-200 rounded-lg" id="edit-book-description"
                    cols="30" rows="10" autocomplete="off">{{ old('description') == '' ? $book->description : old('description') }}</textarea>
                @error('description')
                    <p class="text-red-500 text-sm">{{ $message }}</p>
                @enderror
            </div>
            <div class="grid sm:grid-cols-2 sm:gap-x-4">
                <div class="mb-3">
                    ...
                    <input type="text" class="p-2 w-full border border-slate-200 rounded-lg" name="language"
                        ...
                        value="{{ old('language') == '' ? $book->language : old('language') }}" autocomplete="off">
                    @error('language')
                        <p class="text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="p-2 w-full border border-slate-200 rounded-lg" name="translator"
                        ...
                        value="{{ old('translator') == '' ? $book->translator : old('translator') }}"
                        autocomplete="off">
                    @error('translator')
                        <p class="text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="p-2 w-full border border-slate-200 rounded-lg" name="illustrator"
                        ...
                        value="{{ old('illustrator') == '' ? $book->illustrator : old('illustrator') }}"
                        autocomplete="off">
                    @error('illustrator')
                        <p class="text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="p-2 w-full border border-slate-200 rounded-lg" name="length"
                        ...
                        value="{{ old('length') == '' ? $book->length : old('length') }}" autocomplete="off">
                    @error('length')
                        <p class="text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="p-2 w-full border border-slate-200 rounded-lg" name="house"
                        ...
                        value="{{ old('house') == '' ? $book->house : old('house') }}" autocomplete="off">
                    @error('house')
                        <p class="text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="p-2 w-full border border-slate-200 rounded-lg" name="year"
                        ...
                        value="{{ old('year') == '' ? $book->year : old('year') }}" autocomplete="off">
                    @error('year')
                        <p class="text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="p-2 w-full border border-slate-200 rounded-lg" name="place"
                        ...
                        value="{{ old('place') == '' ? $book->place : old('place') }}" autocomplete="off">
                    @error('place')
                        <p class="text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="number" class="p-2 w-full border border-slate-200 rounded-lg" name="publication"
                        ...
                        value="{{ old('publication') == '' ? $book->publication : old('publication') }}"
                        autocomplete="off">
                    @error('publication')
                        <p class="text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="p-2 w-full border border-slate-200 rounded-lg" name="ISBN"
                        ...
                        value="{{ old('ISBN') == '' ? $book->ISBN : old('ISBN') }}" autocomplete="off">
                    @error('ISBN')
                        <p class="text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="number" class="p-2 w-full border border-slate-200 rounded-lg" name="amount"
                        ...
                        value="{{ old('amount') == '' ? $book->amount : old('amount') }}" autocomplete="off">
                    @error('amount')
                        <p class="text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
