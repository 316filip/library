<div class="flex {{ $placement == 'show' ? 'mb-5 justify-center' : 'items-center border border-slate rounded-lg p-2 shadow-inner mt-2' }}">
    @if ($available === false)
    ...
    @elseif ($available === 'booked')
        <p class="text-slate-500 text-sm {{$placement == 'show' ? '' : 'flex-auto pr-1'}}">Tuto knihu již máte půjčenou</p>
