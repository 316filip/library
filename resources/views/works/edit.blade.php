<x-layout>
    ...
    <div class="flex justify-center">
        <form method="POST" action="/titul/{{ $work->id }}" class="w-full px-2 max-w-2xl 2xl:max-w-3xl">
            @csrf
            @method('PUT')
            <div class="mb-3">
                ...
                <input type="text" class="p-2 w-full border border-slate-200 rounded-lg" name="title"
                    ...
                    value="{{ old('title') == '' ? $work->title : old('title') }}" autocomplete="off">
                @error('title')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="p-2 w-full border border-slate-200 rounded-lg" name="subtitle"
                    ...
                    value="{{ old('subtitle') == '' ? $work->subtitle : old('subtitle') }}" autocomplete="off">
                @error('subtitle')
                    <p class="text-red-500 text-sm">{{ $message }}</p>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="text" class="p-2 w-full border border-slate-200 rounded-lg" name="original_title"
                    ...
                    value="{{ old('original_title') == '' ? $work->original_title : old('original_title') }}"
                    autocomplete="off">
            ...
            <div class="mb-3">
                <x-Select type="author" target="{{ $work->author_id }}" :values=$authors></x-Select>
                @error('author_id')
                    <p class="text-red-500 text-sm">{{ $message }}</p>
                @enderror
            </div>
            <div class="grid sm:grid-cols-2 sm:gap-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="p-2 w-full border border-slate-200 rounded-lg" name="genre"
                        ...
                        value="{{ old('genre') == '' ? $work->genre : old('genre') }}" autocomplete="off">
                    @error('genre')
                        <p class="text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="description" class="p-2 w-full border border-slate-200 rounded-lg" id="edit-work-description"
                    cols="30" rows="10" autocomplete="off">{{ old('description') == '' ? $work->description : old('description') }}</textarea>
                @error('description')
                    <p class="text-red-500 text-sm">{{ $message }}</p>
                @enderror
            </div>
            <div class="grid sm:grid-cols-3 sm:gap-4">
                <div class="mb-3">
                    ...
                    <input type="text" class="p-2 w-full border border-slate-200 rounded-lg" name="language"
                        ...
                        value="{{ old('language') == '' ? $work->language : old('language') }}" autocomplete="off">
                    @error('language')
                        <p class="text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="p-2 w-full border border-slate-200 rounded-lg" name="year"
                        ...
                        value="{{ old('year') == '' ? $work->year : old('year') }}" autocomplete="off">
                    @error('year')
                        <p class="text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="number" class="p-2 w-full border border-slate-200 rounded-lg" name="number"
                        ...
                        value="{{ old('number') == '' ? $work->number : old('number') }}" autocomplete="off">
                    @error('number')
                        <p class="text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
